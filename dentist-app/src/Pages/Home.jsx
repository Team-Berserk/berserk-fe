...
export const Home = () => {
  return (
    <div className="snap-y snap-mandatory h-full overflow-y-scroll">
      <div className="flex flex-col-reverse xl:flex-row duration-500 h-full justify-evenly xl:justify-between px-6 xl:px-40 items-center py-32 xl:py-0" id="home">

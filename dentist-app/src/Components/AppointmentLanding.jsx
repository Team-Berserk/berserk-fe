...
export const AppointmentLanding = () => {
  return (
    <div className="h-1/2 flex justify-center items-center bg-dental bg-fixed bg-center bg-cover">
      <div className="w-[1280px] h-fit lg:h-[200px] rounded-3xl flex flex-col xl:flex-row p-8 m-8 justify-around items-center text-center xl:text-start bg-[#516EFF] text-white">
